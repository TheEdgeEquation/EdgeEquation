...
def run_single_day(label: str, game_date: date):
    print("\n=========================================")
    print(f" OVERSEAS DIAGNOSTIC — {label}")
    print("=========================================")
...
def run_overseas_diagnostic():
    today = date.today()
    tomorrow = today + timedelta(days=1)

    run_single_day("TODAY", today)
    run_single_day("TOMORROW", tomorrow)
