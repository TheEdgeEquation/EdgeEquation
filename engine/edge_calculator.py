...
def calculate_true_lambda_mlb(prop):
    try:
        ...
        if player_id:
            ...
            logger.info(player + " SwStr adj=" + str(swstr_adj) + " pitch mix adj=" + str(pitch_mix_adj))
 
        true_lambda = base_lambda * opp_adj * weather_adj * umpire_adj * park_adj * alt_adj * swstr_adj * pitch_mix_adj
        logger.info("True lambda=" + str(round(true_lambda,3)) + " (opp=" + str(opp_adj) + " wx=" + str(weather_adj) + " ump=" + str(umpire_adj) + " park=" + str(park_adj) + " alt=" + str(alt_adj) + " swstr=" + str(swstr_adj) + " mix=" + str(pitch_mix_adj) + ")")
